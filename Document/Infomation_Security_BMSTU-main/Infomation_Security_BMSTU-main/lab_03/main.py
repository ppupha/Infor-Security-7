...
cx = [  [0x02, 0x03, 0x01, 0x01],
        [0x01, 0x02, 0x03, 0x01],
        [0x01, 0x01, 0x02, 0x03],
        [0x03, 0x01, 0x01, 0x02]]
        
cx1 = [ [0x0e, 0x0b, 0x0d, 0x09],
        [0x09, 0x0e, 0x0b, 0x0d],
        [0x0d, 0x09, 0x0e, 0x0b],
        [0x0b, 0x0d, 0x09, 0x0e]]
    ...
    for i in range(nb):
        ...
        for j in range(4):
            if inv == False:  # encryption
                s[j] =  mult(state[0][i], cx[j][0]) ^ mult(state[1][i], cx[j][1]) ^ mult(state[2][i], cx[j][2]) ^ mult(state[3][i], cx[j][3])
            else:  # decryption
                s[j] = mult(state[0][i], cx1[j][0]) ^ mult(state[1][i], cx1[j][1]) ^ mult(state[2][i], cx1[j][2]) ^ mult(state[3][i], cx1[j][3])
        state[0][i] = s[0]
        state[1][i] = s[1]
        state[2][i] = s[2]
        state[3][i] = s[3]
